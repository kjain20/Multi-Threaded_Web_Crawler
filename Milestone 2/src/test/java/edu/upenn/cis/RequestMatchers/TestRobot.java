package edu.upenn.cis.RequestMatchers;
...
public class TestRobot {
    ...
    public void testForRobot() {
        ...
        PathMatcherOutput pathMatcherOutput = pathMatcher.getMatchingPath(urlInfo, robotFileModel, Constants.getThis().getAllowedUserAgents());
        Assert.assertEquals(true,pathMatcherOutput.isMatch());
    }

    @Test
    public void testForVoidMatch()
    {
        String robotText = "User-agent: *\n" +
                "Disallow: /search\n" +
                "Allow: /search/about\n" +
        ...
        String badCrawler = "badCrawler";
        List<String> crawlerList = new ArrayList<>();
        crawlerList.add(badCrawler);
        URLInfo urlInfo = new URLInfo("www.google.com", "/search/about");
        RobotFileModel robotFileModel = new RobotFileModel(robotText);
        PathMatcher pathMatcher = new PathMatcher();
        PathMatcherOutput pathMatcherOutput = pathMatcher.getMatchingPath(urlInfo, robotFileModel, crawlerList);
        Assert.assertEquals(false,pathMatcherOutput.isMatch());
    }
}
