...
public class URLDBManager {
    ...
    /*
    Two tables: 1. docId DB, table has key -> docId and value is  DocInfo object, DocInfo does not have content type. It just has data. URLIdInfo has
    content type
    2. urlIdstore DB, table has key DomainInfoKey, value is URLIdInfo object.
    ...
    public SecondaryIndex<Integer, DomainInfoKey, URLIdInfo> getUrlIdInfoSecondaryIndex() {
        return urlIdInfoSecondaryIndex;
    }
