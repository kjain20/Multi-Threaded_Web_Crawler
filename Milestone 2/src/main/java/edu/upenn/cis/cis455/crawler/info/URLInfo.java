...
public class URLInfo {
	...
	private URL urlOfThisClass;

	private boolean isthisValidURL = false;
	...
	//equals method to check if the new instance is already in the queue
	public boolean equals(Object obj)
	{
		if(obj instanceof URLInfo)
		{
			URLInfo newInstance = (URLInfo) obj;
			if(((this.getHostName() == null && newInstance.getHostName() == null)
					|| (this.getHostName()!=null && this.getHostName().equals(newInstance.getHostName())))
					&& this.getPortNo() == newInstance.getPortNo()
					&&
					((this.getFilePath() == null && newInstance.getFilePath() == null)
							|| (this.getFilePath()!=null && this.getFilePath().equals(newInstance.getFilePath())))
					&& this.isSecure == newInstance.isSecure) {
				return true;
			}
		}
		return false;
	...
	{
		return this.isthisValidURL;
	}


	public int hashCode()
	{
		String url = String.valueOf(this.isSecure) + "://" + this.hostName + ":" + this.portNo + this.filePath;
		return url.hashCode();
	}

	public URL getURL()
	{
		return urlOfThisClass;
	}
