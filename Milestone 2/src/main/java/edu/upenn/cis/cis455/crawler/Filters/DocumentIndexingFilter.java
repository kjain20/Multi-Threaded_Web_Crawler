    ...
    public void renderRequest(RequestContext requestContext) {
        ...
        if (requestContext.getGetMetaData() != null && requestContext.isValid()) {
            ...
            try {
                ...
                URLIdInfo requestContextURLIdInfo = urldbManager.insertURLDataInfo(domainInfo, requestContext.getTxn()).getURLIdInfo();
                requestContext.setUrlIdInfo(requestContextURLIdInfo);
