...
public class RequestContext {
    ...
    private URLIdInfo urlIdInfo;
    private DomainInfo xPathData;
    ...
    public void setUrlIdInfo(URLIdInfo urlIdInfo) {
        this.urlIdInfo = urlIdInfo;
    }
    ...
    public DomainInfo getxPathData() {
        return xPathData;
    }

    public void setxPathData(DomainInfo xPathData) {
